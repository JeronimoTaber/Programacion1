...
<html lang="en" dir="ltr">
  ...
  <!-- Selecciona la pestaña de create-->
    <?php if($_POST['user_menu']=="create") : ?>
      ...
      <!-- Termina la pestaña de create-->
      <!-- Selecciona la pestaña de delete-->
  <?php endif;
   if($_POST['user_menu']=="delete") : ?>
    ...
    <!-- Termina la pestaña de delete-->
    <!-- Selecciona la pestaña de update-->
    <?php endif;
    if($_POST['user_menu']=="update") : ?>
      ...
      <!-- Termina la pestaña de update-->
      <!-- Selecciona la pestaña de read-->
    <?php endif;
